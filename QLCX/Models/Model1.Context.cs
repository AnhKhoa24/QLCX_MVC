...
namespace QLCX.Models
{
    ...
    public partial class QuanLyCayXanhEntities1 : DbContext
    {
        public QuanLyCayXanhEntities1()
            : base("name=QuanLyCayXanhEntities1")
        {
        }
        ...
        public virtual DbSet<ConDuongQuan> ConDuongQuans { get; set; }
